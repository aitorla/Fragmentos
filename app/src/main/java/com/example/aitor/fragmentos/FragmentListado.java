...
public class FragmentListado extends Fragment {
	...
	private Correo[] datos = 
	    	new Correo[]{
					...
					new Correo("Persona 4", "Asunto del correo 5", "Texto del correo 5"),
                    new Correo("Persona 4", "Asunto del correo 6", "Texto del correo 6"),
					new Correo("Persona 4", "Asunto del correo 7", "Texto del correo 7"),
					new Correo("Persona 4", "Asunto del correo 8", "Texto del correo 8"),
	    			new Correo("Persona 5", "Asunto del correo 9", "Texto del correo 9")};
